...
func (journal *VoteJournal) WriteVote(voteMessage *typess.VoteEnvelope) error {
...
func (journal *VoteJournal) ReadVote(index uint64) (*typess.VoteEnvelope, error) {
	...
	var vote *typess.VoteEnvelope
	if voteMessage != nil {
		vote = &typess.VoteEnvelope{}
